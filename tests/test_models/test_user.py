...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_user_inheritance(self):
        """Test is User a subclass of BaseModel"""
    ...
    def test_Att_types(self):
        """ Test if the type of User attributes"""
        usr = User()
        ...
        self.assertEqual(str, type(usr.email))
        self.assertEqual(str, type(usr.password))
        self.assertEqual(str, type(usr.first_name))
        self.assertEqual(str, type(usr.last_name))
